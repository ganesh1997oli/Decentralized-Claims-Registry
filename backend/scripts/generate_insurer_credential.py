...
def main() -> None:
    ...
    parser.add_argument("insurer_id", help="authoritative insurer ID, e.g. northstar-mutual")
    parser.add_argument("credential_id", help="rotation-friendly ID, e.g. northstar-cloud-v1")
    ...
    if not INSURER_ID_PATTERN.fullmatch(args.insurer_id):
        parser.error(
            "insurer_id must use 3-64 lowercase letters, numbers, and "
            "internal hyphens"
        )
